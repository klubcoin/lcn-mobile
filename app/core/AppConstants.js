...
export default {
	...
	MM_UNIVERSAL_LINK_HOST: 'meetthrufriends.com', //TODO: update host of deeplink
	...
	FIAT_ORDERS: {
		...
		TRANSAK_REDIRECT_URL: 'https://liquichain.io/',
		WYRE_API_ENDPOINT: 'https://api.sendwyre.com/',
		WYRE_API_ENDPOINT_TEST: 'https://api.testwyre.com/',
		WYRE_MERCHANT_ID: 'merchant.io.liquichain.wyre',
		WYRE_MERCHANT_ID_TEST: 'merchant.io.liquichain.wyre.test',
